...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Preferences.behave'
        db.add_column('ide_preferences', 'behave', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Preferences.behave'
        db.delete_column('ide_preferences', 'behave')
