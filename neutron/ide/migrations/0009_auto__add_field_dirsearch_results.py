...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DirSearch.results'
        db.add_column('ide_dirsearch', 'results', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DirSearch.results'
        db.delete_column('ide_dirsearch', 'results')
