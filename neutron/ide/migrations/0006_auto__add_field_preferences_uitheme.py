...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Preferences.uitheme'
        db.add_column('ide_preferences', 'uitheme', self.gf('django.db.models.fields.CharField')(default='kendo', max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Preferences.uitheme'
        db.delete_column('ide_preferences', 'uitheme')
