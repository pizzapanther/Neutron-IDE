...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DirSearch.killed'
        db.add_column('ide_dirsearch', 'killed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DirSearch.killed'
        db.delete_column('ide_dirsearch', 'killed')
