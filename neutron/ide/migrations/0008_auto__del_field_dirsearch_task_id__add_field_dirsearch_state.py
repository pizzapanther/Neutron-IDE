...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DirSearch.task_id'
        db.delete_column('ide_dirsearch', 'task_id')

        # Adding field 'DirSearch.state'
        db.add_column('ide_dirsearch', 'state', self.gf('django.db.models.fields.CharField')(default='created', max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'DirSearch.task_id'
        raise RuntimeError("Cannot reverse this migration. 'DirSearch.task_id' and its values cannot be restored.")

        # Deleting field 'DirSearch.state'
        db.delete_column('ide_dirsearch', 'state')
