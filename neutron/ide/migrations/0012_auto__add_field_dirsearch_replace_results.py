...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DirSearch.replace_results'
        db.add_column('ide_dirsearch', 'replace_results', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DirSearch.replace_results'
        db.delete_column('ide_dirsearch', 'replace_results')
