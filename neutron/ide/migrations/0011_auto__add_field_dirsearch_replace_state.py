...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DirSearch.replace_state'
        db.add_column('ide_dirsearch', 'replace_state', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DirSearch.replace_state'
        db.delete_column('ide_dirsearch', 'replace_state')
