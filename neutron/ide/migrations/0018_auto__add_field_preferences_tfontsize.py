...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Preferences.tfontsize'
        db.add_column('ide_preferences', 'tfontsize', self.gf('django.db.models.fields.CharField')(default='13px', max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Preferences.tfontsize'
        db.delete_column('ide_preferences', 'tfontsize')
