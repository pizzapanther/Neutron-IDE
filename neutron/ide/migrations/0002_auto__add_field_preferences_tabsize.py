...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Preferences.tabsize'
        db.add_column('ide_preferences', 'tabsize', self.gf('django.db.models.fields.IntegerField')(default=4), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Preferences.tabsize'
        db.delete_column('ide_preferences', 'tabsize')
