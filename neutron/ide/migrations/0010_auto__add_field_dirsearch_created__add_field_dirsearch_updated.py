...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DirSearch.created'
        db.add_column('ide_dirsearch', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 12, 18, 20, 46, 35, 700944), blank=True), keep_default=False)

        # Adding field 'DirSearch.updated'
        db.add_column('ide_dirsearch', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 12, 18, 20, 46, 44, 80770), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DirSearch.created'
        db.delete_column('ide_dirsearch', 'created')

        # Deleting field 'DirSearch.updated'
        db.delete_column('ide_dirsearch', 'updated')
