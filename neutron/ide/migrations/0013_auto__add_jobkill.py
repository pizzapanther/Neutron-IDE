...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'JobKill'
        db.create_table('ide_jobkill', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ds', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ide.DirSearch'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('ide', ['JobKill'])


    def backwards(self, orm):
        
        # Deleting model 'JobKill'
        db.delete_table('ide_jobkill')
