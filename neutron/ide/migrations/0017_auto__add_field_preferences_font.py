...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Preferences.font'
        db.add_column('ide_preferences', 'font', self.gf('django.db.models.fields.CharField')(default='"Courier New", Courier, "Lucida Sans Typewriter", "Lucida Typewriter", monospace', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Preferences.font'
        db.delete_column('ide_preferences', 'font')
