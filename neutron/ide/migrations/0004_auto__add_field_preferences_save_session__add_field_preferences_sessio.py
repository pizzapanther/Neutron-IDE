...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Preferences.save_session'
        db.add_column('ide_preferences', 'save_session', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Preferences.session'
        db.add_column('ide_preferences', 'session', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Preferences.save_session'
        db.delete_column('ide_preferences', 'save_session')

        # Deleting field 'Preferences.session'
        db.delete_column('ide_preferences', 'session')
